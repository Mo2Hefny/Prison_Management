...
const DisplayTable = ({ title, dataTable, selectedColumns, UIMode, onClick, rowID}) => {
  ...
  const rows = (Object.entries(dataTable[0])[0] != undefined ? [...dataTable] : [{ [rowID]: 1 }])
  console.log(rows)
  ...
  return (
    <div className='display-grid-container'>
      ...
      <div className='display-table'>
        <DataTable rows={rows} columns={selectedColumns} rowID={rowID}/>
      </div>
    </div>
  )
}
